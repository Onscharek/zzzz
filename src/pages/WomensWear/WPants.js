...
import { setWomenspantsData, setSelectedProduct } from '../../Redux/Actions'
import '../clothes.css'
import Example from '../../comp/Button'; 
import Womenspants from '../../data/pants'; 
...
const WPants = () => {
  ...
  const womenspants= useSelector(state => state.womenspants);
  ...
  const [show, setShow] = useState(false);
                 ...
                 useEffect(() => {
                  dispatch(setWomenspantsData(Womenspants ));
                }, [dispatch]);
    ...
    const Items = [
      { videoId: 'DAdqEGSdQwA', alt: 'Fashion video', link: 'https://www.youtube.com/watch?v=92YIjFE-2k8&list=PL0cA19vPhtoXfSpSGq4Hi00YGRaRKBSMS&ab_channel=EveryDeepMoment' },
      ];
...
<div  style={{display:'flex'}}>
           ...
           style={{
            marginTop:'41%',
              ...
              Discover our latest women's collection Pants,<br/> 
