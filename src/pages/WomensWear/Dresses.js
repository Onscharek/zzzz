...
import { setDressesData, setSelectedProduct } from '../../Redux/Actions'
import '../clothes.css'
...
const Dresses = () => {
    ...
    const [show, setShow] = useState(false);
             ...
             // Fetch data from dressesData.js
    useEffect(() => {
        dispatch(setDressesData(dressesData));
    }, [dispatch]);
...
const Items = [
{ videoId: '92YIjFE-2k8', alt: 'Fashion video', link: 'https://www.youtube.com/watch?v=92YIjFE-2k8&list=PL0cA19vPhtoXfSpSGq4Hi00YGRaRKBSMS&ab_channel=EveryDeepMoment' },
];
...
<div  style={{display:'flex'}}>
              ...
              <p id='prag'
            style={{marginTop:'41%'}}>
              Discover our latest women's collection Dresses,<br/> 
