...
import { setMensshortsData , setSelectedProduct } from '../../Redux/Actions'
import '../clothes.css'
import Example from '../../comp/Button'; 
import MensShorts from '../../data/MansShorts'; 
...
const Shorts = () => {
  ...
  const mensshorts= useSelector(state => state.mensshorts);
  const selectedProduct = useSelector(state => state.selectedProduct);
  const [show, setShow] = useState(false);

                //  Fetch data from mensshortsData.js
                 useEffect(() => {
                  dispatch(setMensshortsData ( MensShorts ));
                }, [dispatch]);
              ...
              const handleClose = () => setShow(false);
                  ...
                  const Items = [
                    { videoId: 'jdD2r37D69k', alt: 'Fashion video', link: 'https://www.youtube.com/watch?v=92YIjFE-2k8&list=PL0cA19vPhtoXfSpSGq4Hi00YGRaRKBSMS&ab_channel=EveryDeepMoment' },
                    ];
      ...
      <div  style={{display:'flex'}}>
           ...
           style={{
            marginTop:'41%',
              ...
              Discover our latest men's collection Shorts,<br/> 
