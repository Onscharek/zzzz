...
import { setMensshirtsData , setSelectedProduct } from '../../Redux/Actions'
import '../clothes.css'
import Example from '../../comp/Button'; 
import MensShirts from '../../data/MansShirts'; 
...
const Shirts = () => {
  ...
  const mensshirts= useSelector(state => state.mensshirts);
  const selectedProduct = useSelector(state => state.selectedProduct);
  const [show, setShow] = useState(false);

                 // Fetch data from pantsData.js
                 useEffect(() => {
                  dispatch(setMensshirtsData ( MensShirts ));
                }, [dispatch]);
              ...
              const handleClose = () => setShow(false);
                  ...
                  const Items = [
                    { videoId: '2-xk8C070mU', alt: 'Fashion video', link: 'https://www.youtube.com/watch?v=92YIjFE-2k8&list=PL0cA19vPhtoXfSpSGq4Hi00YGRaRKBSMS&ab_channel=EveryDeepMoment' },
                    ];
      ...
      <div  style={{display:'flex'}}>
           ...
           style={{
            marginTop:'41%',
              ...
              Discover our latest men's collection Shirts,<br/> 
